...
public class Darbuotojas extends ManoZmogus {

    private int stazas;
    private String specialybe;

    public Darbuotojas(String vardas, String pavarde, int amzius, int stazas, String specialybe) {
    ...
    public String gautiZmogausInformacija() {
        return getVardas() + " " + getPavarde() + " " + getAmzius() + " " + getStazas() + " " + getSpecialybe();
    }
}
